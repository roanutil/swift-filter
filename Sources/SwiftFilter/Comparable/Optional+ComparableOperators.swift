//
//  Optional+ComparableOperators.swift
//  
//
//  MIT License
//
...
extension Optional where Wrapped: Comparable {
    ...
    public static func closure(from filter: ComparableFilter<Wrapped>.Optional) -> ((Self) -> Bool) {
        switch filter {
    ...
    public static func predicate<Model>(
        from filter: ComparableFilter<Wrapped>.Optional,
